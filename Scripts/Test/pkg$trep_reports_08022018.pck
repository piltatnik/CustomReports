...
trans_grouped_second as(     
     select case
              ...
              when series in ('17', '18') then case
             ...
             sum(case 
                    when ct.trans_type='ACTIVE' and series is not null and series not in ('96')
                      then case
                             ...
                             when car.id_operator not in (400246845, 500246845) AND (series not in ('21', '22', '23', '24', '25', '26', '29', '52', '42', '45') or series is null) then sum_trans
                             else 0
                           end
                    when ct.trans_type='PASS' and (series is null OR series in ('96')) and ct.id_operator = car.id_operator AND (ct.id_division = car.id_division OR ct.id_division IS NULL AND car.id_division IS NULL)
    ...
    BEGIN
      ...
      FOR rec IN (WITH agents AS
                     ...
                     (SELECT id,
                             name,
                             case 
                               when id in ('14100246845', '8100246845', '400246845', '500246845', '16100246845') then 
                               2
                             else
                               1 
                             end as group_num
